	...
	switch(actu) {
		...
		case 10:
			...
			function eligeCamino10() {
				...
				aplicaNiveles(13, _lt._nivel, false, 0);
				if (nivel < 1) {
...
function initVert() {
	...
	if (_lt._camino[_lt._actual] >= 12 && _lt._camino[_lt._actual] <= 15 || _lt._camino[_lt._actual] > 20 && _lt._camino[_lt._actual] < 23) {
		_lt._vertActual = 1;
		_lt._vertNum = $('.p14 > .multiPage .singlePage').length;
		$('.p14 > .multiPage').css('top', 0);
		$('.p14 .pArr').on('click', desliVert).siblings('.pAba').on('click', desliVert);
		displayFlechasVert();
	} else if (_lt._camino[_lt._actual] === 15 || _lt._camino[_lt._actual] === 17) {
		_lt._vertActual = 1;
		_lt._vertNum = $('.p16 > .multiPage .singlePage').length;
		$('.p16 > .multiPag').css('top', 0);
		$('.p16 .pArr').on('click', desliVert).siblings('.pAba').on('click', desliVert);
		displayFlechasVert();
	} else if (_lt._camino[_lt._actual] > 34 && _lt._camino[_lt._actual] < 38) {
		_lt._vertActual = 1;
		_lt._vertNum = $('.p36 > .multiPage .singlePage').length;
		$('.p36 > .multiPag').css('top', 0);
		$('.p36 .pArr').on('click', desliVert).siblings('.pAba').on('click', desliVert);
		displayFlechasVert();
	}
